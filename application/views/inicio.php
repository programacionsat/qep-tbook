...
?>
        ...
        <div class="container mt-3 mb-4">
            <h1 class="font-weight-bold"><?php echo $titulo_web; ?> <span class="text-muted" style="font-size: 2rem;"><?php echo $fecha_consulta->format("d/m/Y"); ?></span></h1>
            <div class="row mt-3">
                <div class="col">
...
<!--
            ...
            *******************************************************************
            Aquí van las tablas de Salidas, Zonas y NTTs
            *******************************************************************
